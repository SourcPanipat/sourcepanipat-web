  ...
  return (
    ...
    >
      ...
      <div className="mt-8 text-center">
        <p className="text-xs font-bold text-slate-800 tracking-wider uppercase">Loading Panipat Godown Feed</p>
        <p className="text-[10px] text-slate-400 mt-1">Connecting to Edge Database...</p>
      </div>
    </div>
  );
}
